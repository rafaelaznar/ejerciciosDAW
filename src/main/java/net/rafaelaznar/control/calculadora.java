...
public class calculadora extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("primer operando: " + operando1 + "<br />");
            out.println("segundo operando: " + operando2 + "<br />");
            out.println("operacion: " + operador + "<br />");
            if ("multiplicacion".equals(operador)){
                out.println("resultado: " + parseInt(operando1) * parseInt(operando2) + "<br />");
            }
            out.println("</body>");
            out.println("</html>");
        }
