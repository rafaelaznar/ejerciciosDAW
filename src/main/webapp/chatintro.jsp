...
<html class="no-js">
    ...
    <body>
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span12">
                    <form  class="form-horizontal"  action="ejer10chat" method="post">
                        <h1>Formulario de entrada al chat</h1> 
                        <br />
                        <input type="hidden" name="do" value="login">     
                        <div class="control-group">
                            <label class="control-label" for="user">Nombre:</label>
                            <div class="controls">
                    ...
                    <%
                        ...
                        if (bIntentoFallido != null)
                            if (bIntentoFallido) {
                    %>
                    <h2>Nombre incorrecto. Por favor, inténtalo otra vez.</h2>
                    <% }%>
